...
namespace nmct.ba.cashlessproject.webservice.Models
{
    public class VerenigingDA
    {
        public static int UpdateVereniging(ItOrganisation org)
        {
            ...
            DbParameter par10 = Database.addParameter("AdminConnection", "@Id", org.Id);
            return Database.ModifyData("AdminConnection", sql, par1, par2, par3, par4, par5,par6,par7,par8,par9,par10);
        }
